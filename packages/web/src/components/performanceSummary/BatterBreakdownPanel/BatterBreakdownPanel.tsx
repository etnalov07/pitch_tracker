...
function BatterRow({ batter }: { batter: BatterBreakdown }) {
...
const BatterBreakdownPanel: React.FC<Props> = ({ sections, loading }) => {
    if (loading) {
                    ...
                    <div key={section.title}>
                        ...
                        <BatterList>
                            {[...section.batters]
                                ...
                                .map((batter) => (
                                    <BatterRow key={batter.batter_id} batter={batter} />
                                ))}
                        </BatterList>
                    </div>
                )
