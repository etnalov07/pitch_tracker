...
import { buildLineupPayload, buildPitcherPayload, LineupEntry } from '../../utils/scoutingLineup';
import {
    BattingOrderCell,
    BackButton,
    Container,
...
const emptyLineup = (size: number): LineupEntry[] =>
...
const ScoutingLineup: React.FC = () => {
    ...
    const handleSave = async (side: ActiveTab) => {
        ...
        try {
            ...
            if (pitcherPayload) {
                await opposingPitcherService.create(pitcherPayload);
            }

            setSaved(true);
            // Auto-advance to the other tab after saving Away
