...
import { loadUserRoles, requirePlayerTeamRole, requireTeamRole } from '../middleware/roles';
...
router.post('/team/:team_id/import', requireTeamRole('owner', 'coach'), playerController.importRoster.bind(playerController));
