...
// y convention matches captured pitch data: location_y = 0 is the TOP of the
// strike zone, location_y = 1 is the BOTTOM (SVG-style, since the live
// charting layer derives y from svgY which increases downward).
export const HEAT_ZONES: ZoneDefinition[] = [
    // Inside zones (3x3 grid)
    { id: 'TL', name: 'Top Left', xMin: 0, xMax: 0.33, yMin: 0, yMax: 0.33, isInside: true },
    { id: 'TM', name: 'Top Middle', xMin: 0.33, xMax: 0.67, yMin: 0, yMax: 0.33, isInside: true },
    { id: 'TR', name: 'Top Right', xMin: 0.67, xMax: 1.0, yMin: 0, yMax: 0.33, isInside: true },
    ...
    { id: 'BL', name: 'Bottom Left', xMin: 0, xMax: 0.33, yMin: 0.67, yMax: 1.0, isInside: true },
    { id: 'BM', name: 'Bottom Middle', xMin: 0.33, xMax: 0.67, yMin: 0.67, yMax: 1.0, isInside: true },
    { id: 'BR', name: 'Bottom Right', xMin: 0.67, xMax: 1.0, yMin: 0.67, yMax: 1.0, isInside: true },
    // Outer zones (ring around strike zone)
    { id: 'OTL', name: 'Outside Top Left', xMin: -0.3, xMax: 0, yMin: -0.3, yMax: 0, isInside: false },
    { id: 'OT', name: 'Outside Top', xMin: 0, xMax: 1.0, yMin: -0.3, yMax: 0, isInside: false },
    { id: 'OTR', name: 'Outside Top Right', xMin: 1.0, xMax: 1.3, yMin: -0.3, yMax: 0, isInside: false },
    ...
    { id: 'OBL', name: 'Outside Bottom Left', xMin: -0.3, xMax: 0, yMin: 1.0, yMax: 1.3, isInside: false },
    { id: 'OB', name: 'Outside Bottom', xMin: 0, xMax: 1.0, yMin: 1.0, yMax: 1.3, isInside: false },
    { id: 'OBR', name: 'Outside Bottom Right', xMin: 1.0, xMax: 1.3, yMin: 1.0, yMax: 1.3, isInside: false },
];
